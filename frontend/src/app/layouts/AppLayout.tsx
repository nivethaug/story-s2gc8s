...
const mainNavItems = [
  ...
  { name: 'Thedepths', href: '/thedepths', icon: LayoutDashboard },
  { name: 'Thesource', href: '/thesource', icon: LayoutDashboard },
  { name: 'Thecanopy', href: '/thecanopy', icon: LayoutDashboard },
];
